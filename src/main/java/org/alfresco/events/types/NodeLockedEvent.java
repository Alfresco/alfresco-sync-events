...
public class NodeLockedEvent extends NodeEvent
{
    private static final long serialVersionUID = 7532182209957708629L;

    public static final String EVENT_TYPE = "NODELOCKED";

    NodeLockedEvent()
    {
    }

    public NodeLockedEvent(long seqNumber, String name, String txnId, long time, String networkId, String siteId, String nodeId,
    ...
    {
        return "NodeLockedEvent [nodeModificationTime=" + nodeModificationTime
